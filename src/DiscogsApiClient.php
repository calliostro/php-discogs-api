 ...
 * @method array<string, mixed> collectionFolderCreate(array $params = []) Create a collection folder (OAuth required) — <a href="https://www.discogs.com/developers/#page:user-collection,header:user-collection-create-folder">https://www.discogs.com/developers/#page:user-collection,header:user-collection-create-folder</a>
 ...
 * @method array<string, mixed> collectionFolderDelete(array $params = []) Delete the collection folder (OAuth required) — <a href="https://www.discogs.com/developers/#page:user-collection,header:user-collection-delete-folder">https://www.discogs.com/developers/#page:user-collection,header:user-collection-delete-folder</a>
